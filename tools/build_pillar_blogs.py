  ...
  <main id="main-content">
    <section class="article-hero">
      <div class="container">
        ...
        <h1>{H1_TITLE}</h1>
        <div class="blog-meta">By <a href="https://linkedin.com/company/sdrgrow" target="_blank" rel="noopener" style="color: inherit; text-decoration: underline;">Abir, Founder of SDR GROW</a> · July 2026 · 10 min read</div>
      </div>
    </section>
...
pillars = [
    (r"C:\Users\rubaya\Downloads\SDR GROW\pillar1-recruitment-agency-sales.html", "Strategy", "blog-outreach.png"),
    (r"C:\Users\rubaya\Downloads\SDR GROW\pillar2-recruitment-agency-marketing.html", "Strategy", "blog-brandvoice.png"),
    (r"C:\Users\rubaya\Downloads\SDR GROW\pillar3-staffing-agency-marketing.html", "Lead Generation", "blog-leads.png")
]

cards_to_add = []

for src_path, tag, img_file in pillars:
    ...
    # Remove H1 and author line from body content
    body_content = re.sub(r'<h1>.*?</h1>', '', art_content, count=1).strip()
    body_content = re.sub(r'<p><em>By Abir, Founder of SDR GROW.*?</em></p>', '', body_content, count=1).strip()
    ...
    with open(out_file, 'w', encoding='utf-8') as f:
        f.write(page_html)
    print(f"Created pillar page: {out_file}")
    ...
    if card["slug"] not in blog_page:
        card_html = f"""          <div class="blog-card fade-in">
            ...
            <div class="blog-card-body">
              ...
              <p>{card['desc']}</p>
              <div class="blog-meta">July 2026 · 10 min read</div>
...
if card_blocks:
    ...
    with open(blog_html_path, 'w', encoding='utf-8') as f:
        f.write(blog_page)
    print("Added pillar cards to blog.html")
